...
[X, Y, classification_count] = temp.load_data(100)
...
W = tf.get_variable("W", shape=[classification_count, 1], initializer=tf.contrib.layers.xavier_initializer(dtype=tf.float64))
